...
<body>
    ...
    <div class="upper-nav primary-bg p-2 px-3 text-center text-break">
        ...
        <!-- Promo Banner -->
        <div class="promo-banner p-2 px-3 text-center text-break" style="background: #DB4444; color: #fff; font-size: 1.2rem; font-weight: bold;">
            <span>
                <svg style="vertical-align:middle;margin-right:8px;" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 18a8 8 0 1 1 8-8a8 8 0 0 1-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>
                All Latest Products <span style="color:#ffe066;">Up to 10% off</span> Voucher <span style="background:#fff;color:#DB4444;padding:2px 8px;border-radius:4px;">find it</span>
            </span>
        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#"><img src="assets/images/logo.png" alt="Shop Easy Logo" style="height: 80px;"></a>
    ...
    <div class="landing">
        <div class="container">
            <div class="row m-0">
                <div class="banner">
                    <img src="assets/images/bg.png" alt="Sale Banner" class="banner-image">
